...
def test_dump_toml(temp_file: pathlib.Path, test_nested_data: SettingFile) -> None:
    ...
    expected = """[tool.bar] # automatically generated by pysen. pysen ignores and overwrites any modifications.
a = 1.0
b = 12345
c = "yes"
[tool.bar.d]
...
d-1-b = true
d-1-c = true
[tool.foo] # automatically generated by pysen. pysen ignores and overwrites any modifications.
fuga = ["A", "B", "c", "d"]
hoge = true
piyo = "description"
[tool.foo.hogehoge]
